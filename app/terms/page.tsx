        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              {/* Section 5 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">5. Seller Onboarding and Marketplace Operations</h2>

                <h3 className="text-xl font-semibold text-dark mb-3 mt-6">5.1 Seller Registration and KYC Verification</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-dark mb-3 mt-6">5.2 Seller Responsibilities</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-dark mb-3 mt-6">5.3 Platform Fees and Commissions</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 6 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">6. Delivery Terms</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 7 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">7. Returns, Refunds, and Chargebacks</h2>

                <h3 className="text-xl font-semibold text-dark mb-3 mt-6">7.1 Returns and Refunds</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-dark mb-3 mt-6">7.2 Chargebacks and Payment Disputes</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 8 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">8. User Conduct</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 9 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">9. Intellectual Property</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 11 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">11. Governing Law and Jurisdiction</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 12 */}
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">12. Modifications to Terms</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
