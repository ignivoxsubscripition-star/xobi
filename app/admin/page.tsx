      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((card, index) => (
          <Link
            key={index}
            href={card.link}
            className="bg-white rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-md transition-shadow-md duration-200"
          >
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            <Link
              ...
              className="flex items-center justify-between p-3 bg-primary/5 text-primary rounded-xl hover:bg-primary/10 transition-colors"
            >
            ...
            <Link
              href="/admin/orders"
              className="flex items-center justify-between p-3 bg-blue-50 text-blue-700 rounded-xl hover:bg-blue-100 transition-colors"
            >
